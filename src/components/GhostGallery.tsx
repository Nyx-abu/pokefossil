    ...
    return (
        <div className="flex flex-col h-full overflow-hidden">
            <div className="flex justify-between items-center border-b border-gray-700 pb-3 mb-3 flex-shrink-0">
                ...
                <h1 className="text-lg md:text-xl font-bold font-serif">Ghost Gallery</h1>
            </div>

            <div className="bg-[#1A1815] border border-gray-700 p-3 rounded mb-4 flex-shrink-0">
                <h2 className="text-[var(--color-verdict-ghost)] font-bold text-sm mb-1 font-serif">GHOSTS RECOVERED FROM THE BACKUP BLOCK</h2>
            ...
            {ghosts.length === 0 ? (
                <div className="flex-grow flex items-center justify-center text-gray-500 font-serif text-sm">
                    No ghosts recovered.
                </div>
            ) : (
                        ...
                        <div key={i} className="border border-gray-700 rounded-lg p-3 flex items-center space-x-4 bg-[#1A1815] shadow-md hover:border-gray-500 transition-colors">
                            ...
                            <div className="flex-grow min-w-0">
                                <div className="flex items-center space-x-2 mb-1 flex-wrap gap-1">
                                    <span className="font-bold text-base font-serif truncate">{getDisplayName(g.pokemon.nickname, g.pokemon.species)}</span>
                                    <span className="px-2 py-0.5 rounded text-[10px] font-bold bg-[var(--color-verdict-ghost)]/20 text-[var(--color-verdict-ghost)] border border-[var(--color-verdict-ghost)] font-serif">
                                        {g.type}
                                    </span>
                                </div>
                                <div className="text-xs text-gray-500 mb-1 font-serif">
